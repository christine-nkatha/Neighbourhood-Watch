...
class TestNeighbourhood(TestCase):
    def setUp(self):
        self.new_neigbourhood=NeighbourHood(title = "Title", location="Katheri", county='Meru', neighbourhood_logo="default.jpg", neighbourhood_admin=user)
...
class TestBusiness(TestCase):
    def setUp(self):
        self.new_business=Business(name = "Title", description="boutique", email='1234@gmail.com', neighbourhood="lol.jpg", owner=profile)
